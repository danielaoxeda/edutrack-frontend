    ...
    return (
        <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm mb-6 flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto justify-end">
                {/* Ciclo Selector */}
                <div className="relative flex items-center bg-slate-50 border border-slate-200 hover:bg-slate-100 rounded-xl px-4 py-2.5 cursor-pointer text-xs font-semibold text-slate-600 shadow-sm transition">
                    <span>Ciclo 2024-1</span>
